...
import { EvaluationAttempt, PaymentResponse } from '@/lib/types/interfaces'
...
export function normalizeTransferRequest(request: ChildTransferRequest): ChildTransferRequest {
  return {
    ...request,
  }
}
